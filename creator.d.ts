...
declare module cc {	
	...
	*/
	...
	- createNode<br/>
	- cc.MapObject._serialize<br/>
	- cc.MapObject._deserialize<br/>
	!#zh
	资源基类，该类可以被实例化。<br/>
	...
	export class Intersection {		
		...
		*/
		...
		!#zh 测试圆形与圆形是否相交
		@param a MapObject contains position and radius
		@param b MapObject contains position and radius
		*/
		...
		@param circle MapObject contains position and radius
		*/
	...
	export class Object {		
		...
		/**
		!#en
		Destroy this MapObject, and release all its own references to other objects.<br/>
	...
	export class Color extends ValueType {		
		...
		*/
		...
		```js
		var color = cc.Color.YELLOW;
		color.toHSV(); // MapObject {h: 0.1533864541832669, s: 0.9843137254901961, v: 1};
		``` 
		*/
		toHSV(): any;		
		/**
		...
		@example 
		```js
		cc.Color.rgb2hsv(255, 255, 255); // MapObject {h: 0, s: 0, v: 1};
		``` 
		*/
		...
		@example 
		```js
		cc.Color.hsv2rgb(0, 0, 1); // MapObject {r: 255, g: 255, b: 255};
		``` 
		*/
...
declare module cc.js {	
	...
	*/
	...
	/**
	Define value, just help to call MapObject.defineProperty.<br>
	...
	*/
	...
	/**
	Define get set accessor, just help to call MapObject.defineProperty(...)
	@param obj obj
	@param prop prop
	@param getter getter
	@param setter setter
	...
	*/
	...
	/**
	Define get accessor, just help to call MapObject.defineProperty(...)
	@param obj obj
	@param prop prop
	@param getter getter
	@param enumerable enumerable
	...
	*/
	...
	/**
	Define set accessor, just help to call MapObject.defineProperty(...)
	@param obj obj
	@param prop prop
	@param setter setter
	@param enumerable enumerable
	...
	*/
	...
	/**
	Get class name of the object, if object is just a {} (and which class named 'MapObject'), it will return "".
